...
const docHead = [
	...
	[
		"meta",
		{
			...
			content: "Complete set of tools to scrape google search results",
		},
	],
	...
	[
		"meta",
		{
			name: "keywords",
			content:
				"google, npm, google-sr, google search, searchresults, javascript, typescript, google-search, google-api, scrape",
		},
	],
...
export default defineConfig({
	...
	themeConfig: {
		...
		editLink: {
			pattern:
				"https://github.com/typicalninja/google-sr/tree/master/apps/website/:path",
		},
		socialLinks: [
		...
		footer: {
			...
			copyright:
				'Copyright © 2021-Present <a href="http://typical.vercel.app/">Typicalninja</a> & contributors',
		},
	},
});
