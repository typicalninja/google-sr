...
Consequently, when utilizing the page option, it's advisable to make use of the [`pageToGoogleQueryPage`](https://typicalninja.github.io/google-sr/functions/google_sr.pageToGoogleQueryPage.html) helper that's provided by google-sr. 
...
google-sr also offers a simple helper function that wraps around [`search`](https://typicalninja.github.io/google-sr/functions/google_sr.search.html)
...
Unlike the page options for regular [`search`](https://typicalninja.github.io/google-sr/functions/google_sr.search.html) function, for pages, we'll call the [`pageToGoogleQueryPage`](https://typicalninja.github.io/google-sr/functions/google_sr.pageToGoogleQueryPage.html) helper  internally. 
...
An alternative to the **number of pages** method involves utilizing an array to indicate 
